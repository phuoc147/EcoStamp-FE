...
export default function BottomBar({ role }: { role: Role }) {
  ...
  return (
    /* md:hidden giúp ẩn thanh này khi dùng laptop/máy tính bảng */
    <nav className="fixed bottom-0 left-0 right-0 flex justify-center z-50 md:hidden">
            ...
            return (
              ...
              >
                ...
                <motion.span
                  ...
                  className="text-[10px] font-semibold text-emerald-800/50"
                >
                  {tab.label}
                </motion.span>
              </button>
