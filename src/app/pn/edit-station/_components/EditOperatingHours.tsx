  ...
  return (
    <div className="bg-[#eef6e6] rounded-3xl p-5 mb-5 shadow-sm">
      <div className="flex items-center gap-2 mb-5">
        <Clock size={16} className="text-[#3a7d22]" />
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-[#e3ecd9] text-[#1c3f25] text-xs font-semibold rounded-xl py-3 pl-9 pr-4 outline-none focus:ring-2 focus:ring-[#267a32]/30 uppercase"
            />
          </div>
        </div>
